...
> ![Screenshot of the "Commit new file" area of the page.](./static/Quickstart%20for%20GitHub%20Actions%20/media/image1.png)
...
> ![Screenshot of the tabs for the "github/docs" repository. The "Actions" tab is highlighted with an orange outline.](./static/Quickstart%20for%20GitHub%20Actions%20/media/image2.png)

3.  In the left sidebar, click the workflow you want to display, in this example "GitHub Actions Demo."

> ![Screenshot of the "Actions" page. The name of the example workflow, "GitHub Actions Demo", is highlighted by a dark orange outline.](./static/Quickstart%20for%20GitHub%20Actions%20/media/image3.png)
...
> ![Screenshot of the "Workflow run" page. In the left sidebar, the "Explore-GitHub-Actions" job is highlighted with a dark orange outline.](./static/Quickstart%20for%20GitHub%20Actions%20/media/image4.png)

6.  The log shows you how each of the steps was processed. Expand any of the steps to view its details.

> ![Screenshot of steps run by the workflow.](./static/Quickstart%20for%20GitHub%20Actions%20/media/image5.png)
> 
> For example, you can see the list of files in your repository:![Screenshot of the "List files in the repository" step expanded to show the log output. The output for the step is highlighted with a dark orange highlight.](./static/Quickstart%20for%20GitHub%20Actions%20/media/image6.png)
